...
from src.models.modules.modeling_sentilare_bert import (
    BertEmbeddings,
    BertLayerNorm,
    BertModel,
    BertPreTrainedModel,
...
"""
copied from: https://github.com/thu-coai/SentiLARE/blob/5f1243788fb872e56b5e259939b932346b378419/finetune/modeling_sentilr_roberta.py
"""
...
class RobertaEmbeddings(BertEmbeddings):
    ...
    def __init__(
        self, config, pos_tag_embedding=False, senti_embedding=False, polarity_embedding=False
    ):
